...
exports.sendInvoiceBankTransfer = async function (req, res) {
  try {
    ...
    let paymentInvoicingTable = {
      ...
      transaction_time: formats.getCurrentTimeInJakarta(moment(ressInvoice.data.transaction_time).format(), 'YYYY-MM-DD HH:mm:ss'),
      expiry_time: formats.getCurrentTimeInJakarta(moment(ressInvoice.data.expiry_time).format(), 'YYYY-MM-DD HH:mm:ss'),
